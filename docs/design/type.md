...
The pre-v2 reader faces (Noto Serif, Space Grotesk) are also self-hosted now, loaded only by
`src/styles/reader-legacy.css` for the pinned essay reader; they go away with M2. Material
