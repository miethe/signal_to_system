...
| File | What |
|---|---|
| `sbs-writing.webp` | Writing hub mockup vs `/writing/` (1448, dark) |
| `sbs-devstories.webp` | Dev Stories mockup vs `/dev-stories/` (1448, dark) |
| `sbs-essay.webp` | Pre-v2 reader (M1b capture) vs the M2 re-tokened reader. There is no essay mockup; the reader extends the M1 shell language |
| `essay-rw-dark-1448.webp`, `essay-rw-light-1448.webp`, `essay-rw-dark-390.webp` | Reader specimen: the Registry Wave essay (thread, evidence, figures, rail) |
| `essay-dark-1448.webp` | A plain essay on the same reader |
