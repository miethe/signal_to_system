  ...
  if (!isOpen) {
    return (
      <button
        ...
        title="Search (Cmd+K)"
        className="focus-ring flex h-9 items-center gap-2 rounded-md px-2.5 text-[var(--text-tertiary)] transition-colors hover:bg-[var(--bg-muted)] hover:text-[var(--text-primary)] sm:px-3"
      >
      ...
      >
        ...
        <div className="flex items-center gap-3 border-b border-[var(--border-subtle)] px-4 py-3">
          ...
          <input
            ...
            className="min-w-0 flex-1 bg-transparent text-sm text-[var(--text-primary)] placeholder:text-[var(--text-disabled)] focus:outline-none focus-ring"
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="focus-ring flex h-6 w-6 items-center justify-center rounded text-[var(--text-disabled)] transition-colors hover:bg-[var(--bg-muted)] hover:text-[var(--text-secondary)]"
            >
              ...
              {results.map((result, i) => (
                ...
                >
                  <a
                    href={result.url}
                    onClick={close}
                    className={`focus-ring flex items-start gap-3 px-4 py-3 transition-colors ${
                      i === activeIndex
