  ...
  if (!isOpen) {
    return (
      <button
        ...
        title="Search (Cmd+K)"
        className="focus-ring flex h-9 items-center gap-2 rounded-md px-2.5 text-[var(--text-tertiary)] transition-colors hover:bg-[var(--bg-muted)] hover:text-[var(--text-primary)] focus-visible:outline-none sm:px-3"
      >
