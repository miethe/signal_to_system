  ...
  if (!isOpen) {
    return (
      <button
        ...
        title="Search (Cmd+K)"
        className="focus-ring flex h-9 items-center gap-2 rounded-md px-2.5 text-[var(--text-secondary)] transition-colors hover:bg-[var(--bg-muted)] hover:text-[var(--text-primary)] sm:px-3"
      >
