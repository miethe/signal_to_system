  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between border-b border-zinc-200 bg-zinc-50 px-4 py-2 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <div
          role="tablist"
          aria-label={`${componentName} views`}
      ...
      {tab === "preview" && (
        <div
          ...
          tabIndex={0}
          className="flex min-h-32 items-center justify-center bg-white p-8 dark:bg-zinc-950 focus-ring"
        >
          {renderer ? (
            renderer()
          ) : (
      ...
      {tab === "info" && (
        <div
          ...
          tabIndex={0}
          className="bg-white p-6 dark:bg-zinc-950 focus-ring"
        >
