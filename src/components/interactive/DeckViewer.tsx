    ...
    >
      ...
      {mode === "rich" && slide.notes && (
        <div className="border-t border-zinc-100 dark:border-zinc-800">
          <button
            ...
            className="focus-ring w-full px-4 py-2 text-left text-xs text-zinc-500 hover:text-zinc-700 dark:text-zinc-500 dark:hover:text-zinc-300 transition-colors"
          >
      ...
      <div className="flex items-center justify-between border-t border-zinc-100 px-4 py-3 dark:border-zinc-800">
        <button
          ...
          className="focus-ring flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-sm font-medium text-zinc-600 transition-colors hover:bg-zinc-100 disabled:cursor-not-allowed disabled:opacity-40 dark:text-zinc-400 dark:hover:bg-zinc-800"
        >
          <svg
        ...
        {/* Dot indicators */}
        <div className="flex gap-1.5" role="group" aria-label="Slide selectors">
          {slides.map((_, i) => (
            <button
              key={i}
              type="button"
