...
| Web screenshot capture | Chrome MCP tools | Use directly; integrated with Codex |
...
All scripts in `scripts/` are plain Node.js (ESM). They work with any agent or CI system without Codex-specific features:
...
**Codex enhancements** (when using this skill):
