...
This skill enables Codex to effectively orchestrate Gemini CLI (v0.16.0+) with Gemini 3.1 Pro for code generation, review, analysis, image generation, and specialized tasks.
...
1. **Second Opinion / Cross-Validation**
   ...
   - Finding bugs Codex might have missed
