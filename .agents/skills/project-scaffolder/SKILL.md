...
Transforms project context (PRDs, directories, or free text) into a deployed Bundle of Codex artifacts via a five-step pipeline: analyze → curate → preview → confirm → deploy.
