...
Creates `.Codex/progress/auth-overhaul/phase-2-progress.md` with structured YAML metadata.
...
**Policy**: See `.Codex/specs/doc-policy-spec.md` for documentation limits.
...
- `.Codex/progress/[prd]/phase-N-progress.md` - ONE per phase
- `.Codex/worknotes/[prd]/context.md` - ONE per PRD
- `.Codex/worknotes/fixes/bug-fixes-YYYY-MM.md` - ONE per month
- `.Codex/worknotes/observations/observation-log-MM-YY.md` - ONE per month

See `.Codex/specs/doc-policy-spec.md` for complete policy.
...
- **Documentation Policy**: `.Codex/specs/doc-policy-spec.md`
- **Agent Prompts**: `.Codex/agents/`
- **Phase Execution**: `.Codex/commands/execute-phase.md`
- **Task Delegation**: See AGENTS.md "Agent Delegation" section
